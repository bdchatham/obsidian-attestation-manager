// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/datasync_location_fsx_openzfs_file_system
...
export class DatasyncLocationFsxOpenzfsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationFsxOpenzfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/datasync_location_fsx_openzfs_file_system#import import section} in the documentation of this resource for the id to use

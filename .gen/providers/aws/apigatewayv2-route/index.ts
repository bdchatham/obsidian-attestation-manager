// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/apigatewayv2_route
...
export class Apigatewayv2Route extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/apigatewayv2_route#import import section} in the documentation of this resource for the id to use

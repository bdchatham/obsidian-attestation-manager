// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_delivery_channel
...
export class ConfigDeliveryChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigDeliveryChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_delivery_channel#import import section} in the documentation of this resource for the id to use

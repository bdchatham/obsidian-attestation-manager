// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3outposts_endpoint
...
export class S3OutpostsEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3OutpostsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3outposts_endpoint#import import section} in the documentation of this resource for the id to use

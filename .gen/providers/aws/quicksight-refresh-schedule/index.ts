// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_refresh_schedule
...
export class QuicksightRefreshSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightRefreshSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_refresh_schedule#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/dms_replication_subnet_group
...
export class DataAwsDmsReplicationSubnetGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsReplicationSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/dms_replication_subnet_group#import import section} in the documentation of this resource for the id to use

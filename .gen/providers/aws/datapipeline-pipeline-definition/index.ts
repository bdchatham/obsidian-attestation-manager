// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/datapipeline_pipeline_definition
...
export class DatapipelinePipelineDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatapipelinePipelineDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/datapipeline_pipeline_definition#import import section} in the documentation of this resource for the id to use

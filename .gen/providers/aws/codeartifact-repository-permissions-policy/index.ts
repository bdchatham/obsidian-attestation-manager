// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/codeartifact_repository_permissions_policy
...
export class CodeartifactRepositoryPermissionsPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeartifactRepositoryPermissionsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/codeartifact_repository_permissions_policy#import import section} in the documentation of this resource for the id to use

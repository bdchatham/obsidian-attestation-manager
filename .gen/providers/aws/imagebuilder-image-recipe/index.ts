// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/imagebuilder_image_recipe
...
export class ImagebuilderImageRecipe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderImageRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/imagebuilder_image_recipe#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      systems_manager_agent: {
        value: imagebuilderImageRecipeSystemsManagerAgentToHclTerraform(this._systemsManagerAgent.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ImagebuilderImageRecipeSystemsManagerAgentList",
      },
    };

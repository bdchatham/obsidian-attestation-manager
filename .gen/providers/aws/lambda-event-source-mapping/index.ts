// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lambda_event_source_mapping
...
export class LambdaEventSourceMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaEventSourceMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lambda_event_source_mapping#import import section} in the documentation of this resource for the id to use

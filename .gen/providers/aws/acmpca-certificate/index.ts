...
export class AcmpcaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmpcaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/acmpca_certificate#import import section} in the documentation of this resource for the id to use

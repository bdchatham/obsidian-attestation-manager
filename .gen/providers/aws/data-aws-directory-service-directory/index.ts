// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/directory_service_directory
...
export class DataAwsDirectoryServiceDirectory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDirectoryServiceDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/directory_service_directory#import import section} in the documentation of this resource for the id to use

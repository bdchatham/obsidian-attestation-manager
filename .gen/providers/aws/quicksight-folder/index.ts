// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_folder
...
export class QuicksightFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: quicksightFolderTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "QuicksightFolderTimeouts",
      },
    };

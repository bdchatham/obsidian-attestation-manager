// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lambda_provisioned_concurrency_config
...
export class LambdaProvisionedConcurrencyConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaProvisionedConcurrencyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lambda_provisioned_concurrency_config#import import section} in the documentation of this resource for the id to use

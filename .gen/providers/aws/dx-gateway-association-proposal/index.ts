// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dx_gateway_association_proposal
...
export class DxGatewayAssociationProposal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxGatewayAssociationProposal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dx_gateway_association_proposal#import import section} in the documentation of this resource for the id to use

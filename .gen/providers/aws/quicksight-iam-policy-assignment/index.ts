// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_iam_policy_assignment
...
export class QuicksightIamPolicyAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightIamPolicyAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_iam_policy_assignment#import import section} in the documentation of this resource for the id to use

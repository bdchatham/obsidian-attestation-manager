// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_organization_managed_rule
...
export class ConfigOrganizationManagedRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigOrganizationManagedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_organization_managed_rule#import import section} in the documentation of this resource for the id to use

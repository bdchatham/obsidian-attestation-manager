// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/flow_log
...
export class FlowLog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/flow_log#import import section} in the documentation of this resource for the id to use

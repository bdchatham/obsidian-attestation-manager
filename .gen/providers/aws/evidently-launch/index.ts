// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/evidently_launch
...
export class EvidentlyLaunch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlyLaunch that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/evidently_launch#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scheduled_splits_config: {
        value: evidentlyLaunchScheduledSplitsConfigToHclTerraform(this._scheduledSplitsConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "EvidentlyLaunchScheduledSplitsConfigList",
      },
      timeouts: {
        value: evidentlyLaunchTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EvidentlyLaunchTimeouts",
      },
    };

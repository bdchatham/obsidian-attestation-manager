// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/mskconnect_custom_plugin
...
export class MskconnectCustomPlugin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskconnectCustomPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/mskconnect_custom_plugin#import import section} in the documentation of this resource for the id to use

...
export class DirectoryServiceConditionalForwarder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceConditionalForwarder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/directory_service_conditional_forwarder#import import section} in the documentation of this resource for the id to use

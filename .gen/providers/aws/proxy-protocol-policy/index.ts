// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/proxy_protocol_policy
...
export class ProxyProtocolPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProxyProtocolPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/proxy_protocol_policy#import import section} in the documentation of this resource for the id to use

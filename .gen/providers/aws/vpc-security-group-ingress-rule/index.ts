// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_security_group_ingress_rule
...
export class VpcSecurityGroupIngressRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcSecurityGroupIngressRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_security_group_ingress_rule#import import section} in the documentation of this resource for the id to use

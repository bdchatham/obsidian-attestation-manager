// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/autoscaling_attachment
...
export class AutoscalingAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoscalingAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/autoscaling_attachment#import import section} in the documentation of this resource for the id to use

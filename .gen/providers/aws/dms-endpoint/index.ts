// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dms_endpoint
...
export function dmsEndpointS3SettingsToHclTerraform(struct?: DmsEndpointS3SettingsOutputReference | DmsEndpointS3Settings): any {
  ...
  const attrs = {
    ...
    ignore_headers_row: {
      value: cdktf.numberToHclTerraform(struct!.ignoreHeadersRow),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DmsEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dms_endpoint#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/load_balancer_listener_policy
...
export class LoadBalancerListenerPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadBalancerListenerPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/load_balancer_listener_policy#import import section} in the documentation of this resource for the id to use

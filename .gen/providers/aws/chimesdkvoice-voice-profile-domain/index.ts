// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/chimesdkvoice_voice_profile_domain
...
export class ChimesdkvoiceVoiceProfileDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceVoiceProfileDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/chimesdkvoice_voice_profile_domain#import import section} in the documentation of this resource for the id to use

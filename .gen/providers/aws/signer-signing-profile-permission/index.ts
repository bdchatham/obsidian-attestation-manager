// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/signer_signing_profile_permission
...
export class SignerSigningProfilePermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SignerSigningProfilePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/signer_signing_profile_permission#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/comprehend_document_classifier
...
export class ComprehendDocumentClassifier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComprehendDocumentClassifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/comprehend_document_classifier#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      input_data_config: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "ComprehendDocumentClassifierInputDataConfigList",
      },
      output_data_config: {
        value: comprehendDocumentClassifierOutputDataConfigToHclTerraform(this._outputDataConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ComprehendDocumentClassifierOutputDataConfigList",
      },
      timeouts: {
        value: comprehendDocumentClassifierTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ComprehendDocumentClassifierTimeouts",
      },
      vpc_config: {
        value: comprehendDocumentClassifierVpcConfigToHclTerraform(this._vpcConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ComprehendDocumentClassifierVpcConfigList",
      },
    };

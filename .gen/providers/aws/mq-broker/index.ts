// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/mq_broker
...
export class MqBroker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MqBroker that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/mq_broker#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/guardduty_organization_admin_account
...
export class GuarddutyOrganizationAdminAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyOrganizationAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/guardduty_organization_admin_account#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lightsail_lb_stickiness_policy
...
export class LightsailLbStickinessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailLbStickinessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lightsail_lb_stickiness_policy#import import section} in the documentation of this resource for the id to use

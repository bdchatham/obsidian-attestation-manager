...
export class InternetGatewayAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InternetGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/internet_gateway_attachment#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_custom_layer
...
export function opsworksCustomLayerLoadBasedAutoScalingDownscalingToHclTerraform(struct?: OpsworksCustomLayerLoadBasedAutoScalingDownscalingOutputReference | OpsworksCustomLayerLoadBasedAutoScalingDownscaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function opsworksCustomLayerLoadBasedAutoScalingUpscalingToHclTerraform(struct?: OpsworksCustomLayerLoadBasedAutoScalingUpscalingOutputReference | OpsworksCustomLayerLoadBasedAutoScalingUpscaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function opsworksCustomLayerLoadBasedAutoScalingToHclTerraform(struct?: OpsworksCustomLayerLoadBasedAutoScalingOutputReference | OpsworksCustomLayerLoadBasedAutoScaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OpsworksCustomLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksCustomLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_custom_layer#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      load_based_auto_scaling: {
        value: opsworksCustomLayerLoadBasedAutoScalingToHclTerraform(this._loadBasedAutoScaling.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpsworksCustomLayerLoadBasedAutoScalingList",
      },
    };

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dynamodb_global_table
...
export class DynamodbGlobalTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbGlobalTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dynamodb_global_table#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lb_cookie_stickiness_policy
...
export class LbCookieStickinessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbCookieStickinessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lb_cookie_stickiness_policy#import import section} in the documentation of this resource for the id to use

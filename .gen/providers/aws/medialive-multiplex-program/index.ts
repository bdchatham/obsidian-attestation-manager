// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/medialive_multiplex_program
...
export function medialiveMultiplexProgramMultiplexProgramSettingsVideoSettingsStatemuxSettingsToHclTerraform(struct?: MedialiveMultiplexProgramMultiplexProgramSettingsVideoSettingsStatemuxSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function medialiveMultiplexProgramMultiplexProgramSettingsVideoSettingsToHclTerraform(struct?: MedialiveMultiplexProgramMultiplexProgramSettingsVideoSettings | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    statemux_settings: {
      value: cdktf.listMapperHcl(medialiveMultiplexProgramMultiplexProgramSettingsVideoSettingsStatemuxSettingsToHclTerraform, true)(struct!.statemuxSettings),
      isBlock: true,
      type: "list",
      storageClassType: "MedialiveMultiplexProgramMultiplexProgramSettingsVideoSettingsStatemuxSettingsList",
    },
    statmux_settings: {
...
export class MedialiveMultiplexProgram extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveMultiplexProgram that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/medialive_multiplex_program#import import section} in the documentation of this resource for the id to use

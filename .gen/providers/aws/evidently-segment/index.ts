// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/evidently_segment
...
export class EvidentlySegment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlySegment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/evidently_segment#import import section} in the documentation of this resource for the id to use

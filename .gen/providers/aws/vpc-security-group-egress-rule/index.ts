// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_security_group_egress_rule
...
export class VpcSecurityGroupEgressRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcSecurityGroupEgressRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_security_group_egress_rule#import import section} in the documentation of this resource for the id to use

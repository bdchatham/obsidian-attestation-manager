// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/iam_role
...
export interface IamRoleRoleLastUsed {
}

export function iamRoleRoleLastUsedToTerraform(struct?: IamRoleRoleLastUsed): any {
...
export function iamRoleRoleLastUsedToHclTerraform(struct?: IamRoleRoleLastUsed): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IamRoleRoleLastUsedOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IamRoleRoleLastUsed | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: IamRoleRoleLastUsed | undefined) {
    if (value === undefined) {
...
export class IamRoleRoleLastUsedList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): IamRoleRoleLastUsedOutputReference {
    return new IamRoleRoleLastUsedOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IamRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/iam_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _roleLastUsed = new IamRoleRoleLastUsedList(this, "role_last_used", false);

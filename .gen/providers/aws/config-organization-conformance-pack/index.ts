// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_organization_conformance_pack
...
export class ConfigOrganizationConformancePack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigOrganizationConformancePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_organization_conformance_pack#import import section} in the documentation of this resource for the id to use

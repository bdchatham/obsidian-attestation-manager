// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/fsx_ontap_storage_virtual_machine
...
export class FsxOntapStorageVirtualMachine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxOntapStorageVirtualMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/fsx_ontap_storage_virtual_machine#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/oam_link
...
export class OamLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OamLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/oam_link#import import section} in the documentation of this resource for the id to use

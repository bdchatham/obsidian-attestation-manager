// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssoadmin_customer_managed_policy_attachment
...
export class SsoadminCustomerManagedPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminCustomerManagedPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssoadmin_customer_managed_policy_attachment#import import section} in the documentation of this resource for the id to use

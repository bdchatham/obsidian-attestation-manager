// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3_account_public_access_block
...
export class S3AccountPublicAccessBlock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccountPublicAccessBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3_account_public_access_block#import import section} in the documentation of this resource for the id to use

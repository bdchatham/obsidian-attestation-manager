...
export class OpsworksJavaAppLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksJavaAppLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_java_app_layer#import import section} in the documentation of this resource for the id to use

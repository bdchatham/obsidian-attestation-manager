// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/networkmanager_transit_gateway_peering
...
export function networkmanagerTransitGatewayPeeringTimeoutsToTerraform(struct?: NetworkmanagerTransitGatewayPeeringTimeouts | cdktf.IResolvable): any {
...
export function networkmanagerTransitGatewayPeeringTimeoutsToHclTerraform(struct?: NetworkmanagerTransitGatewayPeeringTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkmanagerTransitGatewayPeering extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_networkmanager_transit_gateway_peering", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: networkmanagerTransitGatewayPeeringTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "NetworkmanagerTransitGatewayPeeringTimeouts",
      },
    };

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/location_tracker_association
...
export class LocationTrackerAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationTrackerAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/location_tracker_association#import import section} in the documentation of this resource for the id to use

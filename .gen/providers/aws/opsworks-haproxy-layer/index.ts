// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_haproxy_layer
...
export function opsworksHaproxyLayerLoadBasedAutoScalingDownscalingToHclTerraform(struct?: OpsworksHaproxyLayerLoadBasedAutoScalingDownscalingOutputReference | OpsworksHaproxyLayerLoadBasedAutoScalingDownscaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function opsworksHaproxyLayerLoadBasedAutoScalingUpscalingToHclTerraform(struct?: OpsworksHaproxyLayerLoadBasedAutoScalingUpscalingOutputReference | OpsworksHaproxyLayerLoadBasedAutoScalingUpscaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function opsworksHaproxyLayerLoadBasedAutoScalingToHclTerraform(struct?: OpsworksHaproxyLayerLoadBasedAutoScalingOutputReference | OpsworksHaproxyLayerLoadBasedAutoScaling): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    downscaling: {
      value: opsworksHaproxyLayerLoadBasedAutoScalingDownscalingToHclTerraform(struct!.downscaling),
      isBlock: true,
      type: "list",
      storageClassType: "OpsworksHaproxyLayerLoadBasedAutoScalingDownscalingList",
    },
    upscaling: {
      value: opsworksHaproxyLayerLoadBasedAutoScalingUpscalingToHclTerraform(struct!.upscaling),
      isBlock: true,
      type: "list",
      storageClassType: "OpsworksHaproxyLayerLoadBasedAutoScalingUpscalingList",
    },
  };
...
export class OpsworksHaproxyLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksHaproxyLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_haproxy_layer#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      load_based_auto_scaling: {
        value: opsworksHaproxyLayerLoadBasedAutoScalingToHclTerraform(this._loadBasedAutoScaling.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpsworksHaproxyLayerLoadBasedAutoScalingList",
      },
    };

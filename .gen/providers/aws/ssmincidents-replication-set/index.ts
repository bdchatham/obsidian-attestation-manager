// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssmincidents_replication_set
...
export class SsmincidentsReplicationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmincidentsReplicationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssmincidents_replication_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _timeouts = new SsmincidentsReplicationSetTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: SsmincidentsReplicationSetTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "SsmincidentsReplicationSetTimeouts",
      },
    };

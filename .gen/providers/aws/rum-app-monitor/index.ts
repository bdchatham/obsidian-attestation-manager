// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/rum_app_monitor
...
export class RumAppMonitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumAppMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/rum_app_monitor#import import section} in the documentation of this resource for the id to use

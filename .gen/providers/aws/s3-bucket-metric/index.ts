// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3_bucket_metric
...
export class S3BucketMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3_bucket_metric#import import section} in the documentation of this resource for the id to use

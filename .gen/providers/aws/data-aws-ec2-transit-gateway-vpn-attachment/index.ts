// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/ec2_transit_gateway_vpn_attachment
...
export function dataAwsEc2TransitGatewayVpnAttachmentTimeoutsToTerraform(struct?: DataAwsEc2TransitGatewayVpnAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsEc2TransitGatewayVpnAttachment extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public putTimeouts(value: DataAwsEc2TransitGatewayVpnAttachmentTimeouts) {

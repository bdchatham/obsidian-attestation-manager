// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/fsx_openzfs_snapshot
...
export function dataAwsFsxOpenzfsSnapshotFilterToHclTerraform(struct?: DataAwsFsxOpenzfsSnapshotFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsFsxOpenzfsSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsFsxOpenzfsSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/fsx_openzfs_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataAwsFsxOpenzfsSnapshotFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",

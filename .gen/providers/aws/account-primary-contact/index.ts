// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/account_primary_contact
...
export class AccountPrimaryContact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountPrimaryContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/account_primary_contact#import import section} in the documentation of this resource for the id to use

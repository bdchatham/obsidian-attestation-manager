...
export class OpsworksStaticWebLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksStaticWebLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_static_web_layer#import import section} in the documentation of this resource for the id to use

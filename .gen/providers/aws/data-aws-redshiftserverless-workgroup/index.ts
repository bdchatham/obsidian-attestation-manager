// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/redshiftserverless_workgroup
...
export class DataAwsRedshiftserverlessWorkgroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRedshiftserverlessWorkgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/redshiftserverless_workgroup#import import section} in the documentation of this resource for the id to use

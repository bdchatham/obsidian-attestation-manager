// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/app_cookie_stickiness_policy
...
export class AppCookieStickinessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppCookieStickinessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/app_cookie_stickiness_policy#import import section} in the documentation of this resource for the id to use

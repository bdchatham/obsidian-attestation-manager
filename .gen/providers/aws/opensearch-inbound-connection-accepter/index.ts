// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opensearch_inbound_connection_accepter
...
export class OpensearchInboundConnectionAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchInboundConnectionAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opensearch_inbound_connection_accepter#import import section} in the documentation of this resource for the id to use

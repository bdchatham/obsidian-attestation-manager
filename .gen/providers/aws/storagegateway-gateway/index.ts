// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/storagegateway_gateway
...
export function storagegatewayGatewayMaintenanceStartTimeToHclTerraform(struct?: StoragegatewayGatewayMaintenanceStartTimeOutputReference | StoragegatewayGatewayMaintenanceStartTime): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class StoragegatewayGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/storagegateway_gateway#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      maintenance_start_time: {
        value: storagegatewayGatewayMaintenanceStartTimeToHclTerraform(this._maintenanceStartTime.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "StoragegatewayGatewayMaintenanceStartTimeList",
      },

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/iot_provisioning_template
...
export function iotProvisioningTemplatePreProvisioningHookToHclTerraform(struct?: IotProvisioningTemplatePreProvisioningHookOutputReference | IotProvisioningTemplatePreProvisioningHook): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    payload_version: {
      value: cdktf.stringToHclTerraform(struct!.payloadVersion),
      isBlock: false,
      type: "simple",
...
export class IotProvisioningTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotProvisioningTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/iot_provisioning_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_iot_provisioning_template", importId: importFromId, provider });
      }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      pre_provisioning_hook: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "IotProvisioningTemplatePreProvisioningHookList",
      },
    };

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_hsm_client_certificate
...
export class RedshiftHsmClientCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftHsmClientCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_hsm_client_certificate#import import section} in the documentation of this resource for the id to use

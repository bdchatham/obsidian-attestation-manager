// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/oam_sink_policy
...
export function oamSinkPolicyTimeoutsToTerraform(struct?: OamSinkPolicyTimeouts | cdktf.IResolvable): any {
...
export function oamSinkPolicyTimeoutsToHclTerraform(struct?: OamSinkPolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OamSinkPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OamSinkPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OamSinkPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class OamSinkPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OamSinkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/oam_sink_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OamSinkPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_oam_sink_policy", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: OamSinkPolicyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new OamSinkPolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OamSinkPolicyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: oamSinkPolicyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: oamSinkPolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OamSinkPolicyTimeouts",
      },
    };

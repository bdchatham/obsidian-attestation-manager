// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sqs_queue_redrive_allow_policy
...
export class SqsQueueRedriveAllowPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqsQueueRedriveAllowPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sqs_queue_redrive_allow_policy#import import section} in the documentation of this resource for the id to use

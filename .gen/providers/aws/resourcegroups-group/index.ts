// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/resourcegroups_group
...
export class ResourcegroupsGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcegroupsGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/resourcegroups_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: resourcegroupsGroupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ResourcegroupsGroupTimeouts",
      },
    };

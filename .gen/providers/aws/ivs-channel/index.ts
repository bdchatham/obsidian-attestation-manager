// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ivs_channel
...
export class IvsChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ivs_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: ivsChannelTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "IvsChannelTimeouts",
      },
    };

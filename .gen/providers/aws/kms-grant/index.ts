// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/kms_grant
...
export class KmsGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/kms_grant#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/macie_member_account_association
...
export class MacieMemberAccountAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MacieMemberAccountAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/macie_member_account_association#import import section} in the documentation of this resource for the id to use

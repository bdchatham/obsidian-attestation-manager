// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/config_organization_custom_policy_rule
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: configOrganizationCustomPolicyRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ConfigOrganizationCustomPolicyRuleTimeouts",
      },
    };

...
export class RamResourceShareAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamResourceShareAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ram_resource_share_accepter#import import section} in the documentation of this resource for the id to use

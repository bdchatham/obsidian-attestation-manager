// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dx_hosted_transit_virtual_interface_accepter
...
export class DxHostedTransitVirtualInterfaceAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxHostedTransitVirtualInterfaceAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dx_hosted_transit_virtual_interface_accepter#import import section} in the documentation of this resource for the id to use

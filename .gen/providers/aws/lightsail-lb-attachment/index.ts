...
export class LightsailLbAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailLbAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lightsail_lb_attachment#import import section} in the documentation of this resource for the id to use

...
export class DataAwsLocationRouteCalculator extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationRouteCalculator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/location_route_calculator#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/apprunner_observability_configuration
...
export class ApprunnerObservabilityConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApprunnerObservabilityConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/apprunner_observability_configuration#import import section} in the documentation of this resource for the id to use

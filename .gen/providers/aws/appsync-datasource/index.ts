// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/appsync_datasource
...
export function appsyncDatasourceOpensearchserviceConfigToTerraform(struct?: AppsyncDatasourceOpensearchserviceConfigOutputReference | AppsyncDatasourceOpensearchserviceConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AppsyncDatasourceOpensearchserviceConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppsyncDatasourceOpensearchserviceConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._endpoint !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: AppsyncDatasourceOpensearchserviceConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._endpoint = undefined;
      this._region = undefined;
...
export class AppsyncDatasource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/appsync_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _opensearchserviceConfig = new AppsyncDatasourceOpensearchserviceConfigOutputReference(this, "opensearchservice_config");

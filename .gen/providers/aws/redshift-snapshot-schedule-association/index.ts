// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_snapshot_schedule_association
...
export class RedshiftSnapshotScheduleAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftSnapshotScheduleAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_snapshot_schedule_association#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/ec2_spot_price
...
export class DataAwsEc2SpotPrice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2SpotPrice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/ec2_spot_price#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _timeouts = new DataAwsEc2SpotPriceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAwsEc2SpotPriceTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAwsEc2SpotPriceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAwsEc2SpotPriceTimeouts",
      },
    };

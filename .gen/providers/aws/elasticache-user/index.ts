// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/elasticache_user
...
export class ElasticacheUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/elasticache_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authentication_mode: {
        value: elasticacheUserAuthenticationModeToHclTerraform(this._authenticationMode.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ElasticacheUserAuthenticationModeList",
      },
      timeouts: {
        value: elasticacheUserTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ElasticacheUserTimeouts",
      },
    };

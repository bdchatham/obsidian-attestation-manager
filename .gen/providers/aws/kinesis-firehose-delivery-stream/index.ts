// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/kinesis_firehose_delivery_stream
...
export class KinesisFirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // parameters - computed: false, optional: true, required: false
  private _parameters = new KinesisFirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorsParametersList(this, "parameters", false);
  public get parameters() {
    return this._parameters;
  }
...
export class KinesisFirehoseDeliveryStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisFirehoseDeliveryStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/kinesis_firehose_delivery_stream#import import section} in the documentation of this resource for the id to use

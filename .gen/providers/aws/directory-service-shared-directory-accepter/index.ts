// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/directory_service_shared_directory_accepter
...
export function directoryServiceSharedDirectoryAccepterTimeoutsToHclTerraform(struct?: DirectoryServiceSharedDirectoryAccepterTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DirectoryServiceSharedDirectoryAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceSharedDirectoryAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/directory_service_shared_directory_accepter#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_directory_service_shared_directory_accepter", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      shared_directory_id: {
        value: cdktf.stringToHclTerraform(this._sharedDirectoryId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      timeouts: {
        value: directoryServiceSharedDirectoryAccepterTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DirectoryServiceSharedDirectoryAccepterTimeouts",
      },
    };

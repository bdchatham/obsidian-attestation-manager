// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/glue_data_catalog_encryption_settings
...
export class GlueDataCatalogEncryptionSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueDataCatalogEncryptionSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/glue_data_catalog_encryption_settings#import import section} in the documentation of this resource for the id to use

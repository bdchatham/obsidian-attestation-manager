// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/memorydb_cluster
...
export class MemorydbCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/memorydb_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      data_tiering: {
        value: cdktf.booleanToHclTerraform(this._dataTiering),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

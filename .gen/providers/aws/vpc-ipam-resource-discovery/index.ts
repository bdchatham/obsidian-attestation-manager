// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_ipam_resource_discovery
...
export class VpcIpamResourceDiscovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamResourceDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_ipam_resource_discovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: VpcIpamResourceDiscoveryConfig) {
    super(scope, id, {
  ...
  private _operatingRegions = new VpcIpamResourceDiscoveryOperatingRegionsList(this, "operating_regions", true);

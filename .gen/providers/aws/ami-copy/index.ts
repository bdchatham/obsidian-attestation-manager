// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ami_copy
...
export class AmiCopy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmiCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ami_copy#import import section} in the documentation of this resource for the id to use

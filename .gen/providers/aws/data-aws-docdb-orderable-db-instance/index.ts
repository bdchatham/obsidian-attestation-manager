// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/docdb_orderable_db_instance
...
export class DataAwsDocdbOrderableDbInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDocdbOrderableDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/docdb_orderable_db_instance#import import section} in the documentation of this resource for the id to use

// https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/dms_endpoint
...
export function dataAwsDmsEndpointElasticsearchSettingsToHclTerraform(struct?: DataAwsDmsEndpointElasticsearchSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAwsDmsEndpointKafkaSettingsToHclTerraform(struct?: DataAwsDmsEndpointKafkaSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAwsDmsEndpointMongodbSettingsToHclTerraform(struct?: DataAwsDmsEndpointMongodbSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsDmsEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/dms_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      elasticsearch_settings: {
        value: cdktf.listMapperHcl(dataAwsDmsEndpointElasticsearchSettingsToHclTerraform, true)(this._elasticsearchSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataAwsDmsEndpointElasticsearchSettingsList",
      },
      kafka_settings: {
        value: cdktf.listMapperHcl(dataAwsDmsEndpointKafkaSettingsToHclTerraform, true)(this._kafkaSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataAwsDmsEndpointKafkaSettingsList",
      },
      mongodb_settings: {
        value: cdktf.listMapperHcl(dataAwsDmsEndpointMongodbSettingsToHclTerraform, true)(this._mongodbSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataAwsDmsEndpointMongodbSettingsList",
      },
    };
